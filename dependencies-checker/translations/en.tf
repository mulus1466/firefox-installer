...
mes7="The directory $cwd/.firefox-installer already exists, do you want to delete it to continue? (Your Firefox configuration is in ~/.mozilla, so, you dont have to worry about losing anything.)"
...
mes14="Language"
mes15="Architecture (If you're not sure, chooose 32-bit)"
